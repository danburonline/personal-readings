...
This repository includes a nanograph property graph (`readings.nano/`) that models relationships between papers, authors, and concepts. The schema is in `readings.pg`, data in `seed.jsonl`, and canned queries in `readings.gq`.

...
| File             | Purpose                                                                                                                                                   |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `readings.pg`    | Schema -- node types (Paper, Author, Concept, TopicFolder) and edge types (Cites, Extends, Contradicts, WrittenBy, Covers, InFolder) |
| `readings.gq`    | Canned queries -- 10 named queries for common operations                                                                                                  |
| `seed.jsonl`     | Data -- all papers and topic folders as JSONL                                                                                               |

...
TOPIC_FOLDERS = [
    ...
    "cellular_and_circuit_neuroscience",
    "cognition_and_representation",
    "computational_neuroscience",
    "consciousness_theories",
    "machine_learning_and_generative_models",
    "mathematical_and_formal_models",
    "mind_uploading_and_digital_minds",
    "network_science_and_dynamics",
    "neural_interfaces_and_neuromodulation",
    "neural_regeneration_and_stem_cells",
    "neural_simulation_and_computation",
    "neural_tissue_engineering_and_organoids",
    "neuromorphic_computing",
    "phenomenology_and_experience",
    "philosophy_of_mind",
    "scientific_methods_and_validation",

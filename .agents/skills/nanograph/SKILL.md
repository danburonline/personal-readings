...
**Nodes:** Paper, Author, Concept, TopicFolder, Figure, Claim, Technique, Definition, OpenQuestion
**Edges:** Cites, Extends, Contradicts, WrittenBy, Covers, InFolder, AffiliatedWith, HasFigure, MakesClaim, UsesTechnique, HasDefinition, Raises

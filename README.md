...
The collection includes a [nanograph](https://github.com/aaltshuler/nanograph) property graph that models relationships between papers, authors, and concepts. This enables cross-topic discovery, citation traversal, and impact analysis that folder structure and semantic search alone cannot provide.

### Files

| File                    | Purpose                                                                                                                                                   |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `_graph/readings.pg`    | Schema -- node types (Paper, Author, Concept, TopicFolder) and edge types (Cites, Extends, Contradicts, WrittenBy, Covers, InFolder) |
| `_graph/readings.gq`    | Canned queries -- 10 named queries for common operations                                                                                                  |
| `_graph/seed.jsonl`     | Data -- all papers and topic folders as JSONL                                                                                               |
